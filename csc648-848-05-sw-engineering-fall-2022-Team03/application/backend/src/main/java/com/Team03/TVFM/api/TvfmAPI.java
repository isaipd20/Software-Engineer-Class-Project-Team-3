...
//    private CartRepo cartRepo;
    ...
    public List<Items> searchItemsFiltered(@RequestBody Items item, @RequestBody Allergens allergens)
    {
...
//        }
    ...
    public String addItemsVendor(@RequestBody Items item, @RequestBody Vendor vendor, @RequestBody Allergens allergens)
    {
        String status = "no items added";
